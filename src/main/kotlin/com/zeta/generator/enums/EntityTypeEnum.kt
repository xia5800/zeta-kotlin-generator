...
enum class EntityTypeEnum(
    ...
    TREE_ENTITY("org.zetaframework.base.entity.TreeEntity", arrayOf("id", "create_time", "created_by", "update_time", "updated_by", "label", "parent_id", "sort_value")),

    /** 包括id、create_time、create_by、update_by、update_time、state字段的表继承的基础实体 */
    STATE_ENTITY("org.zetaframework.base.entity.StateEntity", arrayOf("id", "create_time", "created_by", "update_time", "updated_by", "state")),
